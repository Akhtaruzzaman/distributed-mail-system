...
namespace PosApp.Services
{
    public class NotificationReceiver : BackgroundService
    {
        ...
        public NotificationReceiver(IOptions<RabbitMQSettings> options, ILogger<NotificationReceiver> logger)
        {
            ...
            _channel.QueueDeclare(queue: "pos_callback_queue", durable: false, exclusive: false, autoDelete: false, arguments: null);
            _logger = logger;
        }
        ...
        protected override Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            _channel.BasicConsume(queue: "pos_callback_queue", autoAck: true, consumer: consumer);
